...
class node():   
    def __init__(self, size, board, unhappy, blanks, bias, ratio, groups, agents):
...
def main():
    ...
    for z in range(0, totalNodes):
        ...
        n = node(size, board, unhappy, blanks, bias, ratio, groups, agents)
        nodes.append(n)
    ...
    while True:
        ...
        for z in nodes:
            if len(z.unhappy) != 0: #If unhappy
                ...
                z.board, z.blanks, movetox, movetoy = moveCell(z.blanks, z.board, i, j, z.size, z.bias, z.ratio, z.agents)
                
                z.unhappy = updateUnhappy(z.board, z.size, z.bias, z.ratio, i, j, z.unhappy)
